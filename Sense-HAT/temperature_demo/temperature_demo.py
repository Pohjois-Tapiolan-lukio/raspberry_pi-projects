...
def main():
    ...
    while True:  
        ...
        msg = "{0:.1f}C".format(temp)
        print("Temperature: {0}".format(msg))
        sense.show_message(msg, scroll_speed=.15, text_colour=[255, 0, 0]) # Message to display, Text speed (Bigger number is slower), Text Color (RGB)
